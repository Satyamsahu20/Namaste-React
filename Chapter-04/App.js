...
const Header = () => {
    return(
        <div className="nav-bar" style={{backgroundColor: "black"}}>
            <div className="image2"><img src="https://png.pngtree.com/png-vector/20220708/ourmid/pngtree-fast-food-logo-png-image_5763171.png" width="80px">
            </img></div>
...
const ResCard = (props) => {
    ...
    const {name, cuisines} = restaurant?.data;
    return(
        <div className="res-card">
          <img src="https://static.toiimg.com/thumb/83565509.cms?width=1200&height=900" 
           width={"100%"}
          ></img>
        ...
        <div className="body">
            ...
            {/* <restaurant restaurant={restaurantList} /> */}
             {restaurantList.map((restaurants) => (
                <ResCard key={restaurants.data.id} restaurant={restaurants} />
              ))}
            </div>
        </div>
    )
